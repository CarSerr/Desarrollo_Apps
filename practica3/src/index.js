...
let numerosLi = document.getElementById('liNumeros');
...
let numerosLi2 = document.getElementById('liNumeros2');
...
console.log(miArray);
let miArray2 = ['Mate', 'Rayo Mcqueen', 19, 'Hudson Hornet', 'Franccesco'];
